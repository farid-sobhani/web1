        ...
        <div class="t-header-row">
            ...
            <div class="t-header-left">
                ...
                <div class="join-teachers">
                    <a href="become-a-teacher.html">تدریس در آکادمی</a>
                </div>
                @auth()
                <div class="user-menu-account">
                    <div class="user-image">
                        <img src="@if(is_object(auth()->user()->image))
    ...
    <nav id="navigation" class="navigation">
        ...
        <div class="container">
            <ul class="nav">
                ...
                <li class="main-menu has-sub"><a href="#">{{$category->title}}</a>
                    <div class="sub-menu">
                        <div class="container">

                            @foreach($category->subCategory as $item)
                            <div><a href="android.html">{{$item->title}}</a></div>
                ...
                <li class="main-menu join-teachers-li"><a href="become-a-teacher.html">تدریس در آکادمی</a></li>
